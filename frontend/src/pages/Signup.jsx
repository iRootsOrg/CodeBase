...
const SignUp = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // Redirect or handle sign-up logic here
    navigate("/"); // Navigate to home or another page after sign-up
  };
  ...
  return (
    <section className="bg-blueGray-50 min-h-screen flex flex-col lg:flex-row">
      <div className="lg:w-1/2 xl:w-1/2 bg-gray-800 rounded-r-lg flex justify-center">
        <img
      ...
      <div className="w-full lg:w-1/2 xl:w-1/3 px-4 flex flex-col justify-center mr-auto ml-auto">
          ...
          <div className="flex flex-row items-center justify-center my-3">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="text-center mt-6">
                <button
                  className="bg-gradient-to-r from-cyan-500 via-cyan-600 to-cyan-700 text-white active:bg-blueGray-600 text-sm font-bold uppercase px-6 py-1 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 w-full sm:w-auto ease-linear transition-all duration-150"
                  type="submit"
                >
                  Sign Up
                </button>
        ...
        <footer className="relative  pb-6 mt-0">
